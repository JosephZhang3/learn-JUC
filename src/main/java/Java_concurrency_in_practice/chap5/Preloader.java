...
public class Preloader {
    ...
    public static RuntimeException launderThrowable(Throwable t) {
        // Exception 类和 Error 类都继承自 Throwable 类
        if (t instanceof RuntimeException) {// 继承自 RuntimeException 的 unchecked 类型的异常
            return (RuntimeException) t;
        } else if (t instanceof Error) {// 继承自 Error 而非 Exception 的 unchecked 类型的异常
            throw (Error) t;
        } else {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("结果:" + p.getName());
